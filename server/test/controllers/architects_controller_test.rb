...
class ArchitectsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create architect" do
    assert_difference('Architect.count') do
      post architects_url, params: { architect: { desc: @architect.desc, name: @architect.name, position: @architect.position } }
    end
  ...
  test "should update architect" do
    patch architect_url(@architect), params: { architect: { desc: @architect.desc, name: @architect.name, position: @architect.position } }
